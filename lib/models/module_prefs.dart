...
class ModulePrefs {
  ...
  static const List<SeedPodModule> allModules = [
    ...
    SeedPodModule(
      ...
      title: 'Feeding',
      description:
          'Breast, bottle, formula and solids with side and duration tracking.',
      category: 'core',
      isCore: true,
    ),
    SeedPodModule(
    ...
    SeedPodModule(
      ...
      title: 'Vaccines',
      description:
          'ACT NIP schedule with interactive checkboxes and ACT-funded MenB.',
      category: 'core',
      isCore: true,
    ),
    SeedPodModule(
    ...
    SeedPodModule(
      ...
      title: 'Nappy Log',
      description:
          'Track wet, dirty and mixed changes. Key for monitoring newborn hydration and feeding.',
      category: 'Daily Care',
    ),
    SeedPodModule(
      id: 'medication',
      title: 'Medication',
      description:
          'Record medications, dosages and schedules — paracetamol, antibiotics, vitamin D.',
      category: 'Daily Care',
    ),
    SeedPodModule(
      id: 'appointment',
      title: 'Doctor Visits',
      description:
          'Log GP, paediatrician and specialist visits with diagnoses and follow-ups.',
      category: 'Daily Care',
    ),
    SeedPodModule(
      id: 'health',
      ...
      description:
          'Record temperatures, illnesses and symptoms for chronic condition tracking.',
      category: 'Daily Care',
    ),
    // Development
    SeedPodModule(
      ...
      description:
          'Log first foods and reactions. Helpful from around 4 months.',
    ...
    SeedPodModule(
      ...
      description:
          'Structured screening based on Ages & Stages Questionnaires (ASQ) per age group.',
      category: 'Development',
    ),
    SeedPodModule(
      id: 'teeth',
      title: 'Baby Teeth',
      description:
          'Record each tooth eruption date. First tooth typically around 4–6 months.',
      category: 'Development',
      suggestedFrom: '4+ months',
    ),
    SeedPodModule(
    ...
    SeedPodModule(
      ...
      description:
          'Waitlist tracker for childcare and schools. Canberra queues can start before birth.',
      category: 'Life Admin',
    ),
    SeedPodModule(
      id: 'benefits',
      ...
      description:
          'Track CCS, Family Tax Benefit and Parenting Payment applications.',
      category: 'Life Admin',
    ),
    SeedPodModule(
      id: 'birth_admin',
      title: 'Birth Admin',
      description:
          'Checklist for birth certificate, Medicare, myGov, passport and Centrelink.',
      category: 'Life Admin',
    ),
    SeedPodModule(
      id: 'contacts',
      ...
      description:
          'Authorised carers, emergency contacts and healthcare providers.',
      category: 'Life Admin',
    ),
    // Memories
    SeedPodModule(
      ...
      description:
          'Free-form journal entries and photo links stored privately in your Solid POD.',
      category: 'Memories',
    ),
    SeedPodModule(
      id: 'environment',
